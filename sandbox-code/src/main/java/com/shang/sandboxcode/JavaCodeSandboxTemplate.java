...
import com.shang.sandboxcode.model.ExecuteMessage;
import com.shang.sandboxcode.model.JudgeInfo;
import com.shang.sandboxcode.utils.ProcessUtils;
...
//        2. 编译代码，得到 class 文件
        ...
        if (compileFileExecuteMessage.getErrorMessage()!=null&&compileFileExecuteMessage.getErrorMessage().equals("编译错误")) {
           outputResponse.setMessage(compileFileExecuteMessage.getErrorMessage());
           outputResponse.setStatus(compileFileExecuteMessage.getExitValue());
